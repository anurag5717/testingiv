        ...
        <div className="container-wide mx-auto">
          ...
          >
            ...
            <p className="body-lg text-muted-foreground">
              For over 15 years, we've been India's trusted partner for exceptional events. 
              From corporate conferences to grand weddings, government ceremonies to live concerts, 
              we transform visions into extraordinary experiences.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-secondary/30">
        <div className="container-wide mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {["Odisha", "Delhi NCR", "Maharashtra", "Karnataka", "Tamil Nadu", "West Bengal", "Telangana", "Gujarat", "Rajasthan"].map((state) => (
                <div key={state} className="p-4 bg-background rounded-lg text-center border border-border hover:border-primary/30 transition-colors">
