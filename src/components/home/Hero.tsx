...
const Hero = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Premium corporate event venue" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container-wide mx-auto px-4 md:px-8 py-20">
        <div className="max-w-3xl">
          ...
          delay: 0.4
            ...
            India's trusted partner for corporate events, government projects, live concerts, and grand celebrations. Delivering excellence across 50+ cities.
          </motion.p>
      ...
      delay: 1.5
        ...
        <div className="w-6 h-10 border-2 border-white/30 rounded-full flex justify-center">
          <motion.div className="w-1.5 h-3 bg-white/50 rounded-full mt-2" animate={{
          y: [0, 12, 0]
        }} transition={{
          duration: 1.5,
          repeat: Infinity
